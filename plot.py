...
def plot_ticks(ticks):
	...
	plt.plot(x, y)
	plt.scatter(x_int_leet, y_int_leet, 33, c="r", alpha=0.66, marker=r'$\Delta$', label="Interrupted")
	plt.scatter(x_leet_timing, y_leet_timing, 33, c="r", alpha=0.33, marker=r'$\Delta$', label="Mistimed")
	plt.scatter(x_decay, y_decay, 33, c="g", alpha=0.5, marker=r'$\nabla$', label="Decay")
